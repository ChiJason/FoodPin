...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        //NavigationBar Font Style
        if let barFont = UIFont(name:"HoeflerText-BlackItalic", size: 24.0){
            UINavigationBar.appearance().titleTextAttributes =
                [NSForegroundColorAttributeName:UIColor.whiteColor(),
                 NSFontAttributeName: barFont]
        }
        
        //change lighter color for StatusBar color
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.myswiftlearning.jasonchi.CoreDataDemo" in the application's documents Application Support directory.
